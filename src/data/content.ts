...
export const personal = {
  ...
  linkedin: "https://www.linkedin.com/in/pragadheeshwar-d/",
...
export const certificates = [
  { title: "AI Tools & ChatGPT Workshop", issuer: "be10x", desc: "Completed an AI Tools and ChatGPT workshop covering AI-assisted presentations, data analysis, coding, and debugging.", color: "text-yellow-400", viewUrl: "/certificates/Certificate.pdf", downloadUrl: "/certificates/Certificate.pdf" },
  ...
  { title: "Full Stack Development Internship", issuer: "Thiranex", desc: "Selected for a remote, project-based Full Stack Development internship involving practical projects under industry mentorship.", color: "text-violet-400", viewUrl: "/certificates/OfferLetter_Pragadheeshwar_D.pdf", downloadUrl: "/certificates/OfferLetter_Pragadheeshwar_D.pdf" },
  { title: "GUVI — From Beginner to Data Scientist", issuer: "GUVI × HCL", desc: "Participated in GUVI's webinar “From Beginner to Data Scientist – The Gen Z Career Roadmap,” gaining career-oriented insights into the data science field.", color: "text-cyan-400", viewUrl: "/certificates/HCL%20GUVI%20Certification%20-%20q0110TLHt68hN6j017.png", downloadUrl: "/certificates/HCL%20GUVI%20Certification%20-%20q0110TLHt68hN6j017.png" },
  ...
  { title: "HackDevengers 1.0", issuer: "Devengers", desc: "Participated in HackDevengers 1.0, gaining hands-on exposure to hackathon-based collaboration, innovation, and problem-solving.", color: "text-green-400", viewUrl: "/certificates/Certificate_HackDevengers.pdf", downloadUrl: "/certificates/Certificate_HackDevengers.pdf" },
  ...
  { title: "Introduction to Generative AI Studio", issuer: "Generative AI Studio", desc: "Completed foundational training in Generative AI Studio, gaining an introduction to generative AI concepts and tools.", color: "text-blue-400", viewUrl: "/certificates/Generative_AI_Pragadhees.pdf", downloadUrl: "/certificates/Generative_AI_Pragadhees.pdf" },
  { title: "Learn SQL", issuer: "CodeChef", desc: "Completed all lessons and projects in CodeChef's Learn SQL course, building foundational skills in SQL and database querying.", color: "text-cyan-400", viewUrl: "/certificates/pragadhees_06-Learn%20SQL.pdf", downloadUrl: "/certificates/pragadhees_06-Learn%20SQL.pdf" },
  { title: "Operating Systems", issuer: "Saylor University", desc: "Completed CS401: Operating Systems, a 120-hour course covering core operating system concepts, with a grade of 90%.", color: "text-orange-500", viewUrl: "/certificates/717825F140-Pragadheeshwar%20D.pdf", downloadUrl: "/certificates/717825F140-Pragadheeshwar%20D.pdf" },
  { title: "Pledge Against Drug Abuse", issuer: "Government of Tamil Nadu", desc: "Actively participated in the “Pledge Against Drug Abuse” campaign organized by the Mission Management Unit – Drug Free Tamil Nadu.", color: "text-sky-400", viewUrl: "/certificates/Pragadheeshwar%20D-certificate.pdf", downloadUrl: "/certificates/Pragadheeshwar%20D-certificate.pdf" },
  { title: "Practice Java", issuer: "CodeChef", desc: "Completed all practice problems in CodeChef's Practice Java course, strengthening Java programming and problem-solving skills.", color: "text-red-400", viewUrl: "/certificates/java.pdf", downloadUrl: "/certificates/java.pdf" },
  { title: "Problem Solving (Basic)", issuer: "HackerRank", desc: "Passed the HackerRank Problem Solving (Basic) skill certification test, strengthening algorithmic thinking and fundamental problem-solving skills.", color: "text-sky-400", viewUrl: "/certificates/problem_solving_basic%20certificate.pdf", downloadUrl: "/certificates/problem_solving_basic%20certificate.pdf" },
  { title: "Python (Basic)", issuer: "HackerRank", desc: "Passed the HackerRank Python (Basic) skill certification test, demonstrating foundational Python programming and problem-solving skills.", color: "text-violet-400", viewUrl: "/certificates/python_basic%20certificate.pdf", downloadUrl: "/certificates/python_basic%20certificate.pdf" }
];
